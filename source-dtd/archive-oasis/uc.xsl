...
<xsl:template match="subj-group" mode="l1">
	<br/><xsl:apply-templates mode="l2"/>
	</xsl:template>
...
<xsl:template match="subject" mode="l2">
	<span class="subject_l2"><xsl:apply-templates/></span><br/>
	</xsl:template>

<xsl:template match="subject" mode="l3">
	<span class="subject_l3"><xsl:apply-templates/></span><br/>
	</xsl:template>
...
<!-- ============ NLM CITATION MODEL =============== -->
	...
	<xsl:template match="italic" mode="nscitation">
